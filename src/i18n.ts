...
const translations = {
  ...
  "login.portal": { en: "Login", fr: "Connexion" },
  "login.portal.service": { en: "Service", fr: "Service" },
  "login.portal.electrical": { en: "Electrical", fr: "Électrique" },
  ...
  "login.logout": { en: "Logout", fr: "Déconnexion" },
  ...
  "cart.address": { en: "Street Address *", fr: "Adresse *" },
  "cart.city": { en: "City *", fr: "Ville *" },
  ...
  "filter.brand": { en: "Brand", fr: "Marque" },
  "filter.size": { en: "Size", fr: "Taille" },
  "filter.clear": { en: "Clear filters", fr: "Effacer les filtres" },
  "fit.men": { en: "Men", fr: "Hommes" },
  "fit.women": { en: "Women", fr: "Femmes" },
  "fit.unisex": { en: "Unisex", fr: "Unisexe" },
  "gender.mens": { en: "Men's", fr: "Homme" },
  "gender.womens": { en: "Women's", fr: "Femme" },
  "viewmode.gallery": { en: "Gallery", fr: "Galerie" },
  "viewmode.catalog": { en: "Catalog", fr: "Catalogue" },
  "viewmode.standard": { en: "Standard", fr: "Standard" },
  "variant.Regular": { en: "Regular", fr: "Régulier" },
  "variant.Tall": { en: "Tall", fr: "Grand" },
  "variant.Short": { en: "Short", fr: "Court" },
  "tablet.title": { en: "Tablet coming soon", fr: "Version tablette bientôt disponible" },
  "tablet.sub": { en: "Please visit on mobile or desktop.", fr: "Veuillez consulter sur mobile ou ordinateur." },
  "prov.AB": { en: "Alberta", fr: "Alberta" },
  "prov.BC": { en: "British Columbia", fr: "Colombie-Britannique" },
  "prov.MB": { en: "Manitoba", fr: "Manitoba" },
  "prov.NB": { en: "New Brunswick", fr: "Nouveau-Brunswick" },
  "prov.NL": { en: "Newfoundland and Labrador", fr: "Terre-Neuve-et-Labrador" },
  "prov.NS": { en: "Nova Scotia", fr: "Nouvelle-Écosse" },
  "prov.ON": { en: "Ontario", fr: "Ontario" },
  "prov.PE": { en: "Prince Edward Island", fr: "Île-du-Prince-Édouard" },
  "prov.QC": { en: "Quebec", fr: "Québec" },
  "prov.SK": { en: "Saskatchewan", fr: "Saskatchewan" },
  ...
  "nav.officewelcomekit": { en: "Office Welcome Kit", fr: "Trousse de bienvenue" },
  ...
  "cat.New Hire Kit": { en: "Office Welcome Kit", fr: "Trousse bureau" },
  "cat.newhirekit.short": { en: "Office Kit", fr: "Trousse bureau" },
